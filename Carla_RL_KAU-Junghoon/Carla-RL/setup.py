...
def setup(
    ...
    while attempts < num_max_restarts:
        ...
        carla_executable_path = '/home/ad06/Documents/carla_0.9.13/CARLA_0.9.13/CarlaUE4.sh'
        server = subprocess.Popen(f'DISPLAY= ' + carla_executable_path + f' -opengl ' + f' -carla-rpc-port={port}' + f" -quality-level=Epic ", stdout=None, stderr=subprocess.STDOUT, preexec_fn=os.setsid, env=env, shell=True)
